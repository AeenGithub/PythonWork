...
class DataSave(object):
    ...
    def basic_info(self, json_data, item_id):
        ...
        if json_data['data'].get('item'):
            ...
            filename = 'C:/Users/chenyulei/Desktop/picture/{}.jpg'.format(item_id)
            imgurl= "https:" + image_urls[0]
    ...
    def main(self):
        ...
        for one_shopname in self.get_shop_name():
            ...
            result_basic_info = result_basic_info.loc[result_basic_info['itemId'] != '',:]
            result_basic_info.to_excel('D:\Python\\{}_{}.xlsx'.format(one_shopname, self.datenw))
            print('{}保存成功\n'.format(one_shopname))
        return 'all is over'

if __name__ == '__main__':
    pfile = r"D:\Python\uniqlo_part_1801"
    tm = DataSave(pfile)
    tm.main()
