...
class GetFile(object):
    def __init__(self, files):
        ...
        pref_chrome = {
            ...
            'download.default_directory': 'E:\\中转\\'
        }
    ...
    def path_existed(self):
        if os.listdir(r'E:\中转') is True:
            print('中转文件夹中存在文件，正在删除……')
            os.redir(r'E:\中转')
            os.mkdir(r'E:\中转')
        else:
            pass
        if os.listdir(r'E:\情报通文件') is True:
            print('情报通文件文件夹中存在文件，正在删除……')
            os.redir(r'E:\情报通文件')
            os.mkdir(r'E:\情报通文件')
        else:
            pass
    ...
    def click_button(self, url):
        ...
        period_start.select_by_value('201801')
        period_last = Select(self.driver.find_element_by_id('period_last'))
        period_last.select_by_value('201806')
        self.driver.find_element_by_name('is_mall').click()
        #'#f1 > table > tbody > tr:nth-child(5) > td:nth-child(2) > input:nth-child(2)'
        self.driver.find_element_by_css_selector(
