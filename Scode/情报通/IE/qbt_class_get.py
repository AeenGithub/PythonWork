...
class GetBrand(object):
    ...
    def login_qbt(self):
        ...
        try:
            ...
            self.brandriver.implicitly_wait(30)
    ...
    def sidebar_category_second(self, midclss_url):
        ...
        try:
            WebDriverWait(self.brandriver, 10).until(
                EC.presence_of_element_located(self.locator))
    ...
    def get_link_excel(self):
        ...
        brand_df.to_excel('seniorclss_link2.xlsx')
        with open('seniorclss2', 'wb') as f:
    ...
    def click_button(self, url):
        ...
        # try:
            ...
            self.brandriver.find_element_by_css_selector('#f1 > table > tbody > tr:nth-child(6) > td:nth-child(2) > input:nth-child(1)').click()
        # except exceptions.TimeoutException as e:
        #     self.brandriver.refresh()
    ...
    def main(self):
        ...
        for i in range(df_brand.shape[0]):
            ...
            one_month_table.to_csv(r'D:\Python\Scode\情报通\IE\ele_gather.csv', mode='a', encoding='gbk')
            with open(r'D:\Python\Scode\情报通\IE\ele_gather', mode='wb') as f:
                f.write(pickle.dumps(concat_df))
            df_brand.loc[i+1:].to_csv(r'D:\Python\Scode\情报通\IE\residue.csv', encoding='gbk')
            continue
        print('所有的中类均已完成')
